...
class Demo extends BaseDemo {
    render () {
        const listData = [
            {id: '1', avatar: <Avatar src={imgSrc}/>, content: <div>
                <h4>title 1</h4>
                <p>Australian walks 100km after outback crash.</p>
            </div>, desc: 'description'},
            {id: '2', avatar: <Avatar src={imgSrc}/>, content: <div>
                <h4>title 1</h4>
                <p>Australian walks 100km after outback crash.</p>
            </div>, desc: 'description'},
            {id: '3', avatar: <Avatar src={imgSrc}/>, content: <div>
                <h4>title 1</h4>
                <p>Australian walks 100km after outback crash.</p>
            </div>, desc: 'description'},
            {id: '4', avatar: <Avatar src={imgSrc}/>, content: <div>
                <h4>title 1</h4>
                <p>Australian walks 100km after outback crash.</p>
            </div>, desc: 'description'},
            {id: '5', avatar: <Avatar src={imgSrc}/>, content: <div>
                <h4>title 1</h4>
                <p>Australian walks 100km after outback crash.</p>
            </div>, desc: 'description'}
        ];
        return (
            <div>
                <div className='code-box-demo'>
                    <List data={listData} actions={[<li key='edit'><a className='text-link'>edit</a></li>,
                        <li key='remove'><a className='text-link'>remove</a></li>]}></List>
                </div>
